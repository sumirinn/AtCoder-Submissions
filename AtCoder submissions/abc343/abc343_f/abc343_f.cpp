...
// first->val, second->cnt
// a>b
struct S{
    pii a, b;
    S(pii a=pii(0,0), pii b=pii(0,0)): a(a), b(b) {}
};
...
S op(S x, S y){
    ...
    if(x.a.fi>y.a.fi){
        res.a = x.a;
        if(x.b.fi>y.a.fi) res.b = x.b;
        if(x.b.fi==y.a.fi) res.b = pii(x.b.fi,x.b.se+y.a.se);
        if(x.b.fi<y.a.fi) res.b = y.a;
    }
    if(x.a.fi==y.a.fi){
        res.a = pii(x.a.fi, x.a.se+y.a.se);
        if(x.b.fi>y.b.fi) res.b = x.b;
        if(x.b.fi==y.b.fi) res.b = pii(x.b.fi, x.b.se+y.b.se);
        if(x.b.fi<y.b.fi) res.b = y.b;
    }
    if(x.a.fi<y.a.fi){
        res.a = y.a;
        if(x.a.fi>y.b.fi) res.b = x.a;
        if(x.a.fi==y.b.fi) res.b = pii(x.a.fi,x.a.se+y.b.se);
        if(x.a.fi<y.b.fi) res.b = y.b;
    }

    return res;
};

S e(){return S(pii(-inf+1,0),pii(-inf+1,0));}
...
int main(){
    ...
    rep(qi,q){
        ...
        if(type==1){
            ...
            cin >> p >> x;
            p--;
            t.set(p, S(pii(x,1),pii(-inf,0)));
        }
        if(type==2){
            int l, r;
            cin >> l >> r;
            l--;
            cout << t.prod(l,r).b.se << endl;
        }
    }
}